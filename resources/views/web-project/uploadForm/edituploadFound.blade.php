        ...
        <form action="{{ url('editItem/updated/' . $updateData->id) }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                    ...
                    <div class="mt-6">
                        <label for="file_input_more" class="block mb-2 font-kanit text-white">อัพโหลดภาพเพิ่มเติม (อัพได้สูงสุด 3
                            ไฟล์)</label>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <label for="item-input" class="block mb-2 font-kanit text-white">ของที่พบ</label>
